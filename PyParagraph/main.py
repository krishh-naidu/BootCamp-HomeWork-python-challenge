...
word_count=[]
input_file = Path("BootCamp-HomeWork-python-challenge",'PyParagraph','Resources','paragraph_1.txt')
...
output_file = Path("BootCamp-HomeWork-python-challenge",'PyParagraph','Analysis','Paragraph Analysis.txt')
